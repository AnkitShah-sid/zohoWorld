...
3. #### Model class
    ...
    **com.spring.mongo.demo.model.SuperHero.java**  
    ...
    ```
    **com.spring.mongo.demo.model.User.java**  
    ```
    @Data
    @AllArgsConstructor
    @NoArgsConstructor
...
5. #### JPA And Query operation for Employee
    In **com.spring.mongo.demo.controller.UserController.java** class JPA related queries API Endpoints are placed.
...
- #### Employee Get Operations using JPA
    > **GET Mapping** http://localhost:8080/user-jpa  - Get all Employees 
    
    > **GET Mapping** http://localhost:8080/user-jpa/5f380dece02f053eff29b986  - Get Employee by ID
    
    > **GET Mapping** http://localhost:8080/user-jpa/firstName/Rahul  - Get All Employees with firstname as Rahul 
    
    > **GET Mapping** http://localhost:8080/user-jpa/one-by-firstName/Rahul  - Get **ONE** Employee with firstname as Rahul 
    
    > **GET Mapping** http://localhost:8080/user-jpa/firstName-like/Rahul  - Get All Employees which contains Rahul in their firstname 
    
    > **GET Mapping** http://localhost:8080/user-jpa/one-by-lastName/Ghadage  - Get **ONE** Employee with lastname as Ghadage 
    
    > **GET Mapping** http://localhost:8080/user-jpa/salary-greater-than/10000  - Get All Employees whose salary is grater than 1000 
    
    > **POST Mapping** http://localhost:8080/user-jpa/get-by-condition  - Get All Employees with multiple condition 
...
- #### Employee Get Operations using Queries
    > **GET Mapping** http://localhost:8080/user-query  - Get all Employees 
    
    > **GET Mapping** http://localhost:8080/user-query/firstName/Rahul  - Get All Employees with firstname as Rahul 
    
    > **GET Mapping** http://localhost:8080/user-query/one-by-firstName/Rahul  - Get **ONE** Employee with firstname as Rahul 
    
    > **GET Mapping** http://localhost:8080/user-query/firstName-like/Rahul  - Get All Employees which contains Rahul in their firstname 
    
    > **GET Mapping** http://localhost:8080/user-query/one-by-lastName/Ghadage  - Get **ONE** Employee with lastname as Ghadage 
    
    > **GET Mapping** http://localhost:8080/user-query/salary-greater-than/10000  - Get All Employees whose salary is grater than 1000 
    
    > **POST Mapping** http://localhost:8080/user-query/get-by-condition  - Get All Employees with multiple condition 
